function Lspace = genLHS(FDO,a,e,N,dx)
...
%     
%     % Interior
%     for j = FDO2:Ng-FDO2-1
%         if max(0,ib(j+1)) == 1
%             La(j+1, mod(j-3,Ng)+1 ) = CA(1,FDO2);
%             La(j+1, mod(j-2,Ng)+1 ) = CA(2,FDO2);
%             La(j+1, mod(j-1,Ng)+1 ) = CA(3,FDO2);
%             La(j+1, mod(j-0,Ng)+1 ) = CA(4,FDO2);
%             La(j+1, mod(j+1,Ng)+1 ) = CA(5,FDO2);
%             La(j+1, mod(j+2,Ng)+1 ) = CA(6,FDO2);
%             La(j+1, mod(j+3,Ng)+1 ) = CA(7,FDO2);
% 
%             Ls(j+1, mod(j-3,Ng)+1 ) = CS(1,FDO2);
%             Ls(j+1, mod(j-2,Ng)+1 ) = CS(2,FDO2);
%             Ls(j+1, mod(j-1,Ng)+1 ) = CS(3,FDO2);
%             Ls(j+1, mod(j-0,Ng)+1 ) = CS(4,FDO2);
%             Ls(j+1, mod(j+1,Ng)+1 ) = CS(5,FDO2);
%             Ls(j+1, mod(j+2,Ng)+1 ) = CS(6,FDO2);
%             Ls(j+1, mod(j+3,Ng)+1 ) = CS(7,FDO2);
%            
%         end
%     end
%     
